...
VALUES (
    ...
    '{"features":{"chat":true,"chat.feedback":true,"documents.upload":true,"documents.delete":true,"documents.view":true,"products.view":true,"products.edit":true,"products.delete":true,"share":true,"reindex":true,"analytics":true,"settings":true,"admin":true,"admin.tenants":true,"admin.documents":true,"admin.chats":true,"admin.logs":true,"admin.stats":true,"admin.roles":true,"admin.prompts":true,"mcp":true},"limits":{},"chat_context":{"suggestion_template_role":"default","allowed_query_types":["overview","technical","code","comparison","troubleshooting","chitchat"]}}'
), (
    'user', 'Standard User', 'Default access for new users', TRUE, 0,
    '{"features":{"chat":true,"chat.feedback":true,"documents.upload":true,"documents.delete":true,"documents.view":true,"products.view":true,"products.edit":false,"products.delete":false,"share":true,"reindex":false,"analytics":true,"settings":true,"admin":false,"mcp":true},"limits":{"max_documents":100,"max_tokens_per_day":50000,"max_file_size_mb":50,"max_sessions":500,"max_api_keys":5},"chat_context":{"suggestion_template_role":"default","allowed_query_types":["overview","technical","code","comparison","troubleshooting","chitchat"]}}'
