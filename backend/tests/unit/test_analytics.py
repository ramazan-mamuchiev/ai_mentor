...
class TestChatMessageAnalyticsModel:
    ...
    def test_to_debug_dict_contains_all_keys(self):
        ...
        expected_keys = {
            ...
            "context_tokens", "query_tokens", "history_tokens",
            "system_prompt_tokens", "effective_top_k",
            "history_messages", "prompt_messages",
            "embedding_model", "embedding_api_tokens",
            "product_filter", "version_filter",
            "doc_context", "auto_product", "detected_doc_context", "search_query",
            "query_type", "prompt_hash",
            "user_input_tokens", "user_output_tokens",
            "llm_prompt_tokens", "llm_completion_tokens", "llm_total_tokens",
            "finish_reason", "continuations",
            "classify_input", "classify_product",
            "classify_prompt_tokens", "classify_completion_tokens",
            "classify_total_tokens", "classify_model", "classify_ms",
            "rerank_prompt_tokens", "rerank_completion_tokens",
            "rerank_total_tokens", "rerank_model",
            "decompose_used", "decompose_sub_queries", "decompose_sub_products",
            "decompose_prompt_tokens", "decompose_completion_tokens",
            "decompose_total_tokens", "decompose_model", "decompose_ms",
            "web_search_used", "web_search_queries", "web_search_sources_count",
            "web_search_prompt_tokens", "web_search_completion_tokens",
            "web_search_total_tokens", "web_search_model", "web_search_ms",
            "web_search_context_length",
            "rewrite_prompt_tokens", "rewrite_completion_tokens",
            "rewrite_total_tokens", "rewrite_model",
            "retry_used", "rephrase_ms", "rephrase_query",
            "rephrase_prompt_tokens", "rephrase_completion_tokens",
            "rephrase_total_tokens", "rephrase_model",
            "summary_prompt_tokens", "summary_completion_tokens",
            "summary_total_tokens", "summary_model", "summary_ms",
        }
